...
size_t dpdk_default_tx_burst_size = 256; // TODO: Why here? Should be a configurable parameter...
size_t dpdk_default_rx_burst_size = 256; // TODO: Why here? Should be a configurable parameter...
